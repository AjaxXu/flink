 ...
 *
 * <p>A symbol type only accepts conversions from and to its enum class.符号类型仅接受来自其枚举类的转换
 *
 * <p>This type has no serializable string representation.此类型没有可序列化的字符串表示形式
 *
