...
public interface OutputTypeConfigurable<OUT> {
	...
	/**
	 * Is called by the {@link org.apache.flink.streaming.api.graph.StreamGraph#addOperator(Integer, String, String, StreamOperator, TypeInformation, TypeInformation, String)}
